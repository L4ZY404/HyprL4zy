...
lock_cache_dir="$cache_root/hyprl4zy"
lock_wallpaper="$lock_cache_dir/lock-wallpaper.jpg"
wal_colors="$cache_root/wal/colors"
lock_dim_percent="${HYPRL4ZY_LOCK_DIM_PERCENT:-42}"
lock_fade_seconds="${HYPRL4ZY_LOCK_FADE_SECONDS:-0.85}"
lock_blur_strength="${HYPRL4ZY_LOCK_BLUR_STRENGTH:-3x2}"
lock_vignette="${HYPRL4ZY_LOCK_VIGNETTE:-0.12:0.52}"
